...
const const_1 = require("../api/const");
const symptomMapper = {
...
const sendPatientstatus = async (userId, statusObj, channelAccessToken) => {
  const date = date_1.convertTimestampToStr({
    dateObj: statusObj.lastUpdatedAt,
  });
  ...
  switch (statusObj.status) {
    case const_1.statusList["G1"]:
      resultMessagePayload = messagePayload.slice(0, 1);
      break;
    case const_1.statusList["G2"]:
    case const_1.statusList["Y1"]:
    case const_1.statusList["Y2"]:
      resultMessagePayload = messagePayload.slice(0, 2);
      break;
    case const_1.statusList["R2"]:
    case const_1.statusList["R3"]:
  ...
  await axios_1.default(axiosConfig);
  console.log("message:", message);
};
module.exports = { sendPatientstatus };
//# sourceMappingURL=linepushmessage.js.map
